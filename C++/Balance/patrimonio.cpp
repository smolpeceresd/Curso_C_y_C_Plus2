...
Patrimonio::Patrimonio(const string &descripcion_, double monto_, const string  &fecha_, bool circulante_no_circulante)
...
void Patrimonio::print(ofstream &fichero) const
{
    /*cout<<"\n-----------------------------------------";
